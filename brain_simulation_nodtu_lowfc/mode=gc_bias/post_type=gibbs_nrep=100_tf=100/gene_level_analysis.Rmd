...
```
Even at the gene level, swish is only able to capture 2066 genes, while mapping differential transcripts to genes is able to capture more(2315/2320). But there still exists 106 genes captured by dge analysis missed by differential transcript analysis and 99 by our method
