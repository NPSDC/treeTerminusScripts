...
corMean <- corMean/12
print(head(corMean))
save(corMean, file = "environment/brain_sim_nodtu/mode=gc_bias/post_type=gibbs_nrep=100_tf=100/updated/comp_trees/cor_mean.RData")
d <- (1+corMean)/2
trMeanCorUPGMANorm <- UPGMA(d)
trMeanCorUPGMANorm$tip.label <- rownames(infReps)
save(trMeanCorUPGMANorm, file="environment/brain_sim_nodtu/mode=gc_bias/post_type=gibbs_nrep=100_tf=100/updated/comp_trees/trMeanCorUPGMANorm.RData")
```