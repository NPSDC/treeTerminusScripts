...
print(system.time(cSwish <- getCand(tree,
                 ...
                 p_column = "pvalue",
                 sign_column = "log2FC")))
save(cSwish, file = "environment/brain_sim_nodtu/mode=gc_bias/post_type=gibbs_nrep=100_tf=100/benchmark/cSwish.RData")
# gc()
bSwish <- list()
...
save(bSwish, file = "environment/brain_sim_nodtu/mode=gc_bias/post_type=gibbs_nrep=100_tf=100/benchmark/bSwish.RData")
gc()
