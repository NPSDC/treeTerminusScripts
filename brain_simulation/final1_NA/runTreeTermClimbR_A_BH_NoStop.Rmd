...
print(system.time(tAfterBHNoStop <- runTreeTermAlphas(tree, yAll, "condition", -10000, pCutOff = 0.05, pChild = 0.05, runType = c("a"), corr = c("BH"), alphas = c(0.01, 0.05, 0.10), cores = 3, compPThresh = T, cSign = F, temp=T)))
save(tAfterBHNoStop, file = "environment/brain_sim/final1_NA/tAfterBH_NoStop.RData")