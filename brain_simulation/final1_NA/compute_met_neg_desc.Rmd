...
load("environment/brain_sim/final1_NA/tBeforeNoStopQval.RData")
load("environment/brain_sim/final1_NA/tBeforeQval.RData")
...
detNodes[["tBeforeqvalNoStop"]] <- lapply(tBeforeNoStopQval, function(ta) ta[["candNodeO"]])
...
# negNodes[["tAfterIHW"]] <- lapply(tAfterIHW, function(ta) unlist(Descendants(tree, c(ta[["naNodeO"]], ta[["negNodeO"]]))))
# negNodes[["tAfterIHWNoSign"]] <- lapply(tAfterIHWNoSign, function(ta) unlist(Descendants(tree, c(ta[["naNodeO"]],ta[["negNodeO"]]))))
# negNodes[["tAfterIHWNoStop"]] <- lapply(tAfterIHWNoStop, function(ta) unlist(Descendants(tree, c(ta[["naNodeO"]],ta[["negNodeO"]]))))
...
negNodes[["tAfterqvalNoSign"]] <- lapply(tAfterNoSign, function(ta) unlist(Descendants(tree, c(ta[["naNodeO"]],ta[["negNodeO"]]))))
negNodes[["tAfterqvalNoStop"]] <- lapply(tAfterNoStop, function(ta) unlist(Descendants(tree, c(ta[["naNodeO"]],ta[["negNodeO"]]))))

negNodes[["tBeforeqval"]] <- lapply(tBeforeQval, function(ta) unlist(Descendants(tree, c(ta[["naNodeO"]],ta[["negNodeO"]]))))
negNodes[["tBeforeqvalNoStop"]] <- lapply(tBeforeNoStopQval, function(ta) unlist(Descendants(tree, c(ta[["naNodeO"]],ta[["negNodeO"]]))))
