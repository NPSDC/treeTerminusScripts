...
print("tAfterIHW")
print(system.time(tAfterIHW <- runTreeTermAlphas(tree, yAll, "condition", minInfRV, pCutOff = 0.05, pChild = 0.05, runType = c("a"), corr = c("IHW"), alphas = c(0.01, 0.05, 0.10), cores = 3, compPThresh = T, file="environment/brain_sim/tAfterIHW_incomp.RData")))
save(tAfterIHW, file = "environment/brain_sim/tAfterIHW.RData")

print("tAfterIHWNoStop")
print(system.time(tAfterIHWNoStop <- runTreeTermAlphas(tree, yAll, "condition", -100000, pCutOff = 0.05, pChild = 0.05, runType = c("a"), corr = c("IHW"), alphas = c(0.01, 0.05, 0.10), cores = 3, compPThresh = T, cSign = F, file="environment/brain_sim/tAfterIHWNoStop_incomp.RData")))
save(tAfterIHWNoStop, file = "environment/brain_sim/tAfterIHWNoStop.RData")

print("tAfterIHWNoThresh")
print(system.time(tAfterIHWNoSign <- runTreeTermAlphas(tree, yAll, "condition", 0.20, pCutOff = 0.05, pChild = 0.05, runType = c("a"), corr = c("IHW"), alphas = c(0.01, 0.05, 0.10), cores = 3, compPThresh = T, cSign = F, file="environment/brain_sim/tAfterIHWNoSign_incomp.RData")))
