...
fasta <- file.path(ann_dir, "gencode.v26.transcripts.short.names.fa")
...
writeXStringSet(txseq, file.path(ann_dir,"transcripts.fa"))
...
data_dir="/fs/cbcb-lab/rob/students/noor/Uncertainity/treeTerminusScripts/environment/brain_sim"
save(tpms, dge.genes, dte.genes, dtu.genes,
     ...
     file=file.path(data_dir,"simulate.rda"))
